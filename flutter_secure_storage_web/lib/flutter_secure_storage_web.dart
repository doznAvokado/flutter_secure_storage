...
class FlutterSecureStorageWeb extends FlutterSecureStoragePlatform {
  ...
  Future<bool> containsKey({
    ...
    required Map<String, String> options,
      ...
      Future.value(
        html.window.sessionStorage.containsKey("${options[_publicKey]!}.$key"),
      );
  ...
  Future<void> delete({
    ...
    html.window.sessionStorage.remove("${options[_publicKey]!}.$key");
  }
  ...
  Future<String?> read({
    ...
    final value = html.window.sessionStorage["${options[_publicKey]!}.$key"];
  ...
  Future<void> write({
    ...
    html.window.sessionStorage["${options[_publicKey]!}.$key"] = encoded;
  }
